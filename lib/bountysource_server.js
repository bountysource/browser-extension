        ...
        onChange: function(state) {
          ...
          if (state.checked) {
            panel = require("sdk/panel").Panel({
              ...
              contentURL: data.url("popup/layout_firefox.html"),
              contentScriptFile: [
                data.url("popup/vendor/js/angular-1.2.27.js"),
                data.url("popup/vendor/js/angular-route-1.2.26.min.js"),
                data.url("popup/vendor/js/angular-sanitize-1.2.26.min.js"),
                data.url("popup/vendor/js/ui-bootstrap-tpls-0.11.2.min.js"),
                data.url("bountysource_client.js"),
                data.url("popup/application.js"),
                data.url("popup/filters/dollars.js"),
                data.url("popup/home.js"),
                data.url("popup/feedback.js"),
                data.url("popup/layout.js")
              ],
              contentScriptOptions: {
                image_base: data.url('images/')
              },
